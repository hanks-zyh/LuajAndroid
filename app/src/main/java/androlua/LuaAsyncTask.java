...
public class LuaAsyncTask extends AsyncTask implements LuaGcable {
    ...
    protected Object doInBackground(Object[] args) {
        ...
        try {
            ...
            mLuaContext.toast("AsyncTask" + e.getMessage());
        }
        ...
        try {
            ...
            mLuaContext.toast("doInBackground" + e.getMessage());
        }
    ...
    protected void onPostExecute(Object result) {
        ...
        try {
            ...
            mLuaContext.toast("onPostExecute" + e.getMessage());
        }
    ...
    protected void onProgressUpdate(Object[] values) {
        ...
        try {
            ...
            mLuaContext.toast("onProgressUpdate" + e.getMessage());
        }
