...
local LuaAsyncTask=luajava.bindClass("androlua.LuaAsyncTask")
local LuaThread=luajava.bindClass("androlua.LuaThread")
local LuaTimer=luajava.bindClass("androlua.LuaTimer")
