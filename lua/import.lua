...
local loaders = {} -- store function to load class

local LuaAsyncTask = bindClass("androlua.LuaAsyncTask")
local LuaThread = bindClass("androlua.LuaThread")
local LuaTimer = bindClass("androlua.LuaTimer")
