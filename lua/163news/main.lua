...
function onCreate(savedInstanceState)
    ...
    -- LuaHttp.request( {url='http://img2.cache.netease.com/f2e/wap/touch_index_2016/trunk/js/newaplib.DSCqS6aALkim.3.js'},
    --     function (e,code,body)
    --         uihelper.runOnUiThread(activity, function ()
    --             for name,id in string.gmatch(body, '{name:"(\\u.-)".-articleList:{topicid:"(.-)"') do
    --               if name and id and #id == 16 then
    --                 data.titles[#data.titles + 1] = unicode_to_utf8(name)
    --                 data.fragments[#data.fragments + 1]  =  fragmentNews.newInstance(unicode_to_utf8(id))
    --               end
    --             end    
