...
function onCreate(savedInstanceState)
    ...
    btn_1.onClick = function(v)
        AlertBuilder(activity).setTitle('LuaTitle').setMessage('from lua script').setPositiveButton('OK', luajava.createProxy("android.content.DialogInterface$OnClickListener", {
